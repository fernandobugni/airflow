...
from openapi_server.models.create_alert_payload_all_of import CreateAlertPayloadAllOf  # noqa: E501
from openapi_server.models.recipient import Recipient  # noqa: E501

class CreateAlertPayload(Model):
    ...
    def __init__(self, user=None, note=None, source=None, message=None, alias=None, description=None, responders=None, visible_to=None, actions=None, tags=None, details=None, entity=None, priority=None):  # noqa: E501
        """CreateAlertPayload - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CreateAlertPayload':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CreateAlertPayload of this CreateAlertPayload.  # noqa: E501
        :rtype: CreateAlertPayload
        """
        return util.deserialize_model(dikt, cls)

    @property
    def user(self):
        """Gets the user of this CreateAlertPayload.

        Display name of the request owner  # noqa: E501

        :return: The user of this CreateAlertPayload.
        :rtype: str
        """
        return self._user
    ...
    def user(self, user):
        ...
        :param user: The user of this CreateAlertPayload.
        :type user: str
        """
    ...
    @property
    def note(self):
        """Gets the note of this CreateAlertPayload.

        Additional note that will be added while creating the alert  # noqa: E501

        :return: The note of this CreateAlertPayload.
        :rtype: str
        """
        return self._note
    ...
    def note(self, note):
        ...
        :param note: The note of this CreateAlertPayload.
        :type note: str
        """
    ...
    def source(self, source):
        ...
        :param source: The source of this CreateAlertPayload.
        :type source: str
        """
    ...
    @property
    def message(self):
        """Gets the message of this CreateAlertPayload.

        Message of the alert  # noqa: E501

        :return: The message of this CreateAlertPayload.
        :rtype: str
        """
    ...
    def message(self, message):
        ...
        :param message: The message of this CreateAlertPayload.
        :type message: str
        """
        if message is None:
    ...
    def alias(self, alias):
        ...
        :param alias: The alias of this CreateAlertPayload.
        :type alias: str
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this CreateAlertPayload.
        :type description: str
        """
    ...
    @property
    def responders(self):
        """Gets the responders of this CreateAlertPayload.

        Responders that the alert will be routed to send notifications  # noqa: E501

        :return: The responders of this CreateAlertPayload.
    ...
    def responders(self, responders):
        ...
        :param responders: The responders of this CreateAlertPayload.
        :type responders: List[Recipient]
        """
    ...
    def visible_to(self, visible_to):
        ...
        :param visible_to: The visible_to of this CreateAlertPayload.
        :type visible_to: List[Recipient]
        """
    ...
    @property
    def actions(self):
        """Gets the actions of this CreateAlertPayload.

        Custom actions that will be available for the alert  # noqa: E501

        :return: The actions of this CreateAlertPayload.
        :rtype: List[str]
        """
    ...
    def actions(self, actions):
        ...
        :param actions: The actions of this CreateAlertPayload.
        :type actions: List[str]
        """
    ...
    @property
    def tags(self):
        """Gets the tags of this CreateAlertPayload.

        Tags of the alert  # noqa: E501

        :return: The tags of this CreateAlertPayload.
        :rtype: List[str]
        """
        return self._tags
    ...
    def tags(self, tags):
        ...
        :param tags: The tags of this CreateAlertPayload.
        :type tags: List[str]
        """
    ...
    @property
    def details(self):
        """Gets the details of this CreateAlertPayload.

        Map of key-value pairs to use as custom properties of the alert  # noqa: E501

        :return: The details of this CreateAlertPayload.
        :rtype: Dict[str, str]
        """
    ...
    def details(self, details):
        ...
        :param details: The details of this CreateAlertPayload.
        :type details: Dict[str, str]
        """
    ...
    def entity(self, entity):
        ...
        :param entity: The entity of this CreateAlertPayload.
        :type entity: str
        """
    ...
    @property
    def priority(self):
        """Gets the priority of this CreateAlertPayload.

        Priority level of the alert  # noqa: E501

        :return: The priority of this CreateAlertPayload.
        :rtype: str
        """
    ...
    def priority(self, priority):
        ...
        :param priority: The priority of this CreateAlertPayload.
        :type priority: str
        """
